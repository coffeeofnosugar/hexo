...
>   
>   - 另外有一个特殊情况：勾选+Remote时，用户打开游戏的时候会先向服务器确认是否有更新<font color="darkgray">（注意：这时如果服务器上没有catalog文件的时候，有时能显示图片，有时不能显示图片，即使用户本地有资产，很奇怪）</font>，然后再显示图片（没有更新：直接显示本地的；有更新：获取远程的）。具体流程如下图
>   
>     <img class="half" src="/../images/unity/热更新学习笔记/热更新/Local Group组热更新.drawio.png"></img>
...
<img class="half" src="/../images/unity/热更新学习笔记/热更新/9-创建新包体1.png1"></img>

<img class="half" src="/../images/unity/热更新学习笔记/热更新/9-创建新包体2.png2"></img>
